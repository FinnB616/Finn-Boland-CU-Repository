...
% MODIFY THIS SECTION
% /////////////////////////////////////////////////////////////////////////
    DragPolar_mod1(n,:)=Parasite_Data.CDo(n)+((WingLiftCurve{n,:}').^2).*InducedDrag_Data.k1_mod1(n)+InducedDrag_Data.k2_mod1(n).*((WingLiftCurve{n,:}'));
    DragPolar_mod2(n,:)=Parasite_Data.CDo(n)+((WingLiftCurve{n,:}').^2).*InducedDrag_Data.k1_mod2(n)+InducedDrag_Data.k2_mod2(n).*((WingLiftCurve{n,:}'));
    DragPolar_mod3(n,:)=Parasite_Data.CDo(n)+((WingLiftCurve{n,:}').^2).*InducedDrag_Data.k1_mod3(n)+InducedDrag_Data.k2_mod3(n).*((WingLiftCurve{n,:}'));
% /////////////////////////////////////////////////////////////////////////
...
%% Plots for this function (Figure 50 - 59)
...
if Plot_DragPolar_Data == 1
    ...
    for n=1:Count
        ...
        if Count == 1
            print('Drag Polar Plot','-dpng','-r300')
        end
    end
